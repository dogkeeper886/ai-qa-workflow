...
├── README.md                      # Project overview (generated by /jr-trace-verify)
├── confluence/                    # HLD and design documentation
│   ├── [Page_Title].md            # Confluence page content (downloaded by /jr-trace-docs)
│   └── confluence_links.md        # Index of all Confluence links (generated by /jr-trace-verify)
├── 00_Main_Task_[TICKET].md       # Main ticket details (downloaded by /jr-trace-docs)
├── 01_[Description]_[TICKET].md   # Related tickets (downloaded by /jr-trace-docs)
└── Ticket_Relationship_Diagram.md # Visual ticket relationships (generated by /jr-trace-verify)
```
