...
```
active/[TICKET]_[Short_Description]/
...
**Later phases add:**
```
├── test_plan/                     # Created during /planning-tests
│   ├── README.md
│   └── sections/
├── test_cases/                    # Created during /designing-cases
│   └── README.md
└── demo/                          # Created during /creating-demo
...
| `demo/screenshots/` | During demo review |
